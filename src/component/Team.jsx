...
const Team = () => {
  return (
    <>
      {" "}
      <section className="team-section black py-xl-5">
        <div className="container modified-container my-xl-4 mb-xl-5">
          ...
          <div className="row mb-xl-5 pb-5 justify-content-center">
            <div className="col-8 col-sm-6 col-lg-3 pe-lg-3 mt-3 mt-sm-0">
            ...
            <div className="col-8 col-sm-6 col-lg-3 pe-lg-3 mt-5 mt-sm-0">
              <div className="team-card">
                <div className="card-img">
            ...
            <div className="col-8 col-sm-6 col-lg-3 pe-lg-3 mt-5 mt-lg-0">
              <div className="team-card">
                <div className="card-img">
            ...
            <div className="col-8 col-sm-6 col-lg-3 mt-4 mt-5 mt-lg-0 m-auto">
              <div className="team-card">
                <div className="card-img">
