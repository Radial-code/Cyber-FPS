      ...
      <section className="py-5 overflow-hidden" id="cyber-fps">
        <div className="container modified-container my-lg-5 py-lg-5">
          <div className="row justify-content-center ">
            <div
              className="col-12 col-lg-6 order-2 order-lg-1 mt-4 mt-sm-5 mt-lg-0 d-flex flex-column justify-content-center text-center text-lg-start "
              data-aos="fade-right"
              data-aos-duration="1500"
            >
              <h2 className="fs-xl fw-400 mb-4 mb-xl-4 pb-2 pb-xl-3 ff-audiowide position-relative">
                <span className=" d-lg-inlign-block pb-1 me-4">Non</span>
                purus
              </h2>
